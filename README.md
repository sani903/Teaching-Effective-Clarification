...
- `evaluation/benchmarks/swe_bench/` – Contains scripts for running evaluation.
- `evaluation/benchmarks/swe_bench/scripts/main_run_infer.sh` – Main script to run inference experiments.
- `data/data.xlsx` – Generated clarification questions by different models and their rewrites.
- `openhands/training/train.py` – Training code for the clarification question generation models.
...
- `data/data.xlsx` – Contains clarification questions generated by different models along with human rewrites
